/**
 * Unified CRM - Export Index
 */

export { brandingService, BRANDS } from './brandingService.js';
export { unifiedContactService, STAGES, SOURCES, CHANNELS } from './unifiedContactService.js';
